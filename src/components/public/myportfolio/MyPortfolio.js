            ...
            <section className='portfolio my-shadow rounded p-3 mx-2 bg-neutral-focus text-white flex flex-wrap justify-center gap-y-3 gap-x-10'>
                ...
                <section className='basis-80 shrink space-y-3'>
                    <div className='fromTop flex-wrap'>
                        <h3>Name :</h3>
                        <input className="input input-bordered input-sm max-w-xs" value="Muhammad Nafis Abdullah" readOnly />
                    </div>

                    <div className='fromRight flex-wrap'>
                        <h3>Email :</h3>
                        <input className="input input-bordered input-sm max-w-xs" value="nafisabdullah2@gmail.com" readOnly />
                    </div>

                    <section className='space-y-2'>
                        <h3 className='underline underline-offset-2 fromBottom'>Education Background :</h3>
                        <div className="overflow-x-auto border-[4px] rounded-xl text-neutral-focus fromTop">
                ...
                <section className='flex flex-col items-start gap-2 basis-80 shrink'>
                    ...
                    <div className='fromTop'>
                        <input type="checkbox" className="checkbox ring-2 ring-white checkbox-xs" checked readOnly />
                ...
                <section className='basis-full'>
                    <section className='max-w-xs mx-auto'>
                        ...
                        <section className='flex flex-col gap-3'>
                            <a href='https://dr-tooth-nafis-abdullah.web.app/' target="_blank" rel='noreferrer' className="btn btn-sm glass fromRight">First Project</a>
                            <a href='https://watches-arena.netlify.app/' target="_blank" rel='noreferrer' className="btn btn-sm glass fromLeft">Second Project</a>
                            <a href='https://mna-car-dealer.web.app/' target="_blank" rel='noreferrer' className="btn btn-sm glass fromBottom">Third Project</a>
                        </section>
                    </section>
                </section>
