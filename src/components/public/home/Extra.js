...
const Extra = () => {
    return (
        <div className='justify-center pb-10 space-y-3'>
            ...
            <div className='bg-slate-400/10 rounded p-3  flex flex-wrap gap-x-10 gap-y-5 justify-center'>
            ...
            <div className='bg-slate-400/10 rounded p-3  flex flex-wrap-reverse justify-center gap-x-10 gap-y-5'>
                <div className='max-w-sm w-full'>
